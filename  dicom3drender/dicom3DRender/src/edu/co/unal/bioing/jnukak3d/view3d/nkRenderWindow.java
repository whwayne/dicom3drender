...
import net.dzzd.DzzDContainer;

/**
 * Class for represent abstract window.
 * @author Alexander Pinzon Fernandez apinzon@gmail.com
 */
public abstract class nkRenderWindow extends DzzDContainer{
    /**
     * Render the scene.
     */
