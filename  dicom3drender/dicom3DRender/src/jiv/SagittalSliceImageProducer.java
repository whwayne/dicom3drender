...
public final class SagittalSliceImageProducer extends SliceImageProducer {
    ...
    public SagittalSliceImageProducer( nkData3DVolume data_volume,
				       int default_slice, 
	...
	super( default_slice,
            new int[ data_volume.getYSize() * data_volume.getZSize()],
	       data_volume.getYSize(),
	       data_volume.getZSize(),
	       default_colormap,
	       data_volume);
    ...
    /*private*/ final void _getNewSliceData( boolean future_notification) {
        ...
        if(slice_data!=null)
            ...
            data_volume.getSagittalSlice( crt_slice, slice_data_int,
				      future_notification ? this : null );
