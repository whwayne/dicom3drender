...
public final class TransverseSliceImageProducer extends SliceImageProducer {
    ...
    public TransverseSliceImageProducer( nkData3DVolume data_volume,
					 int default_slice, 
    ...
    public TransverseSliceImageProducer( nkData3DVolume data_volume,
					 int default_slice,
					 IndexColorModel default_colormap, int dataType ) {

	super( default_slice,
	       new int[ data_volume.getXSize() * data_volume.getYSize()],
	       data_volume.getXSize(),
	       data_volume.getYSize(),
	       default_colormap,
	       data_volume);
	...
	data_volume.getTransverseSlice( crt_slice, slice_data, 
            ...
            data_volume.getTransverseSlice( crt_slice, slice_data_int,
					future_notification ? this : null );
