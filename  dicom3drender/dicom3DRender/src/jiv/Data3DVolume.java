...
import jiv.VolumeHeader.ResampleTable;
 ...
 */
public final class Data3DVolume implements nkData3DVolume{
    ...
    */
    ...
    public byte getVoxelAsByte(int x, int y, int z) {
        return ((Byte)getVoxel( x, y, z)).byteValue();
    }
    ...
    */
	...
	for( int y= y_size - 1, offset= 0; y >= 0; --y, offset += x_size)
	    System.arraycopy( voxels[ z][ y], 0, (byte[])slice, offset, x_size);
	...
	for( int z= z_size - 1, offset= 0; z >= 0; --z, offset += y_size) 
		...
		((byte[])slice)[ offset + y]= voxels[ z][ y][ x];
    ...
    */
    ...
    public int getDataType() {
        return nkData3DVolume.TYPE_BYTE;
    }
