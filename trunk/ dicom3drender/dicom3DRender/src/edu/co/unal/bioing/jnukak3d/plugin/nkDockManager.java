 ...
 * @author Alexander Pinzon Fernandez
 */
public abstract class nkDockManager {
    private final HashMap attributes = new HashMap();

    public abstract void config(Object windowParent, Object panelContent);
    public abstract void readTree(nkBinaryTreeLayout root);
